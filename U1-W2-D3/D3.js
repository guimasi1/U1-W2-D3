...
if (crewMass <= 500) {
  ...
  console.log("Critical Load: Over 700");
} else if (crewMass > 500) {
  console.log("Critical Load: Over 500");
}
...
console.log(
  `His/Her name is  ${starWarsCharacters[randomIndex].name}, with an height of ${starWarsCharacters[randomIndex].height}. Hair color ${starWarsCharacters[randomIndex].hair_color}, Skin color ${starWarsCharacters[randomIndex].skin_color}, eyes color ${starWarsCharacters[randomIndex].eye_color}. He's born in ${starWarsCharacters[randomIndex].birth_year}, the gender is ${starWarsCharacters[randomIndex].gender}.`
);
